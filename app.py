...
import os
from projects.schedulemastermind.app import schedulemastermind  # Import the blueprint with updated path

app = Flask(__name__)
app.register_blueprint(schedulemastermind, url_prefix='/projects/schedulemastermind')
...
projects = [
    ...
    },
    {
        ...
        "link": "/projects/schedulemastermind"
    },
    {
        "id": "8",
...
def experience():
    ...
    if not project_id:
        return "Project ID is missing", 400  # Return an error if no project_id is provided
